        ...
        <div className="row g-4">
          <div className="col-md-4">
            ...
            <span className="d-flex mt-3">
              <a href="https://github.com/github-john-doe"><img src={iconesGithub} alt="Icone GitHub" className="me-2 icon-white social-icon" width="25" height="25"/></a>
              <a href="https://twitter.com/twitter-john-doe"><img src={iconesTwitter} alt="Icone Twitter" className="me-2 icon-white social-icon" width="25" height="25"/></a>
              <a href="https://linkedin.com/in/linkedin-john-doe"><img src={iconesLinkedin} alt="Icone LinkedIn" className="me-2 icon-white social-icon" width="25" height="25"/></a>
            </span>
          </div>
